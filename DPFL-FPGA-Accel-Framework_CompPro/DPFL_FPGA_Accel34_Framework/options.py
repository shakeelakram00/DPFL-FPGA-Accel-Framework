...
def args_parser():
    ...
    parser.add_argument('--sampling_prob', type=float, default=0.03425 , help='sampling_prob')
    #parser.add_argument('--xtrain_shape', type=tuple, default=(187,1,1) , help='xtrain_shape') #added for 5 ectopic model
    parser.add_argument('--xtrain_shape', type=tuple, default=(1,1,187) , help='xtrain_shape') #added for 5 ectopic model    
    ...
    parser.add_argument('--dr_from_np', type=float, default=1, help='for 5_Ectopic dataset')                    
